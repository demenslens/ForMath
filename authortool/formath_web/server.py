        ...
        try:
            ...
            if overwrite_id:
                ...
                try:
                    ...
                    pass
                # BELANGRIJK: pas ook het 'id'-veld in de metadata aan, zodat
                # de inhoud van het bestand overeenkomt met de bestandsnaam.
                # Zonder deze stap krijgt elke bewerkte opgave het ID van
                # vandaag in metadata, terwijl het bestand zijn oorspronkelijke
                # naam behoudt.
                if 'metadata' in result:
                    result['metadata']['id'] = overwrite_id
