/* ============================================================================
 * i18n.js — lichte internationalisatie voor de studenttool.
 *
 * Laadt de meertalige catalogus (i18n.json: glossary + ui) en biedt:
 ...
 *   I18N.applyI18n(root) → vult alle [data-i18n]/[data-i18n-title] elementen
...
(function () {
  ...
  var listeners = [];
  try { var saved = localStorage.getItem('werkblad.lang'); if (saved) lang = saved; } catch (e) {}
  ...
  function setLang(l) {
    lang = l;
    try { localStorage.setItem('werkblad.lang', l); } catch (e) {}
  ...
  function load() {
    fetch('i18n.json?v=11').then(function (r) { return r.json(); }).then(function (data) {
      catalog = data;
